...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-human-name | *Version*:2.2.0 |
| Active as of 2026-03-19 | *Computable Name*:FRCoreHumanNameProfile |
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/humanname-assembly-order|5.2.0"]
      }]
    },
    {
      "id" : "HumanName.prefix",
