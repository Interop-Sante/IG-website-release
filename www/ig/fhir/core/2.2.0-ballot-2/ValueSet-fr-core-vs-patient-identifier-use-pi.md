# FR Core ValueSet Patient identifier use PI - Guide d'implémentation FR Core v2.2.0-ballot-2
...
| Active as of 2026-01-29 | *Computable Name*:FRCoreValueSetPatientIdentifierUsePI |
