# FR Core ValueSet Patient contact role - Guide d'implémentation FR Core v2.2.0-ballot-2
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-patient-contact-role | *Version*:2.2.0-ballot-2 |
