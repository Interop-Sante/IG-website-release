# FR Core ValueSet Organization Champ Activite - Champ d'activité clinique de l'organisation type UF - Guide d'implémentation FR Core v2.2.0-ballot-2
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-organization-champ-activite | *Version*:2.2.0-ballot-2 |
| Active as of 2026-01-29 | *Computable Name*:FRCoreValueSetOrganizationChampActivite |
