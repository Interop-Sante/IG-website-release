# FR Core Observation Body Temperature Profile - Guide d'implémentation FR Core v2.2.0-ballot-2
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-observation-body-temperature | *Version*:2.2.0-ballot-2 |
| Active as of 2026-01-29 | *Computable Name*:FRCoreObservationBodyTemperatureProfile |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "min" : 0,
        "max" : "1",
        "patternCanonical" : "https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-observation-body-temperature|2.2.0-ballot-2"
      },
      {
      ...
      },
      {
        ...
        "binding" : {
          "strength" : "example",
          "valueSet" : "https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vsbody-temp-meas-body-location|2.2.0-ballot-2"
        }
      }
    ]
  }
