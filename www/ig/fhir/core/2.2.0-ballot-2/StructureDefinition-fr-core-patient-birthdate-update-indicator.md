# FR Core Patient Birthdate Update Indicator Extension - Guide d'implémentation FR Core v2.2.0-ballot-2
...
| Active as of 2026-01-28 | *Computable Name*:FRCorePatientBirthDateUpdateIndicatorExtension |
