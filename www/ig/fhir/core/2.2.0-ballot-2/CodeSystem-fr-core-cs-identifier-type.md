# FR Core CodeSystem Identifier Type - Guide d'implémentation FR Core v2.2.0-ballot-2
...
| Draft as of 2026-01-29 | *Computable Name*:FRCoreCodeSystemIdentifierType |
