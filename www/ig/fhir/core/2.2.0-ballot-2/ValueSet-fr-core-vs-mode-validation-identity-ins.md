# FR Core ValueSet Mode validation identity INS - Guide d'implémentation FR Core v2.2.0-ballot-2
...
| Active as of 2026-01-29 | *Computable Name*:FRCoreValueSetModeValidationIdentityINS |
