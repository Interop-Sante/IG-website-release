# FR Core ValueSet Organization Type Activité - nomenclature SAE - Guide d'implémentation FR Core v2.2.0-ballot-2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **FR Core ValueSet Organization Type Activité - nomenclature SAE**

## ValueSet: FR Core ValueSet Organization Type Activité - nomenclature SAE 

| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-oragnization-type-activite | *Version*:2.2.0-ballot-2 |
| Active as of 2026-01-29 | *Computable Name*:FRCoreValueSetOrganizationTypeActivite |
