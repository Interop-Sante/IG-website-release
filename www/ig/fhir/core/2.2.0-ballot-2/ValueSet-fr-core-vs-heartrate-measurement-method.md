# Heart Rate Measurement Method value set - Guide d'implémentation FR Core v2.2.0-ballot-2
...
| Active as of 2026-01-28 | *Computable Name*:FRCoreValueSetHeartRateMeasurementMethod |
