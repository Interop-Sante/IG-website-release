# FR Core Organization Extension - Tarif Soin - Guide d'implémentation FR Core v2.2.0
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-organization-tarif | *Version*:2.2.0 |
| Active as of 2026-03-19 | *Computable Name*:FRCoreOrganizationTarifExtension |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.fr.core|current/StructureDefinition/fr-core-organization-tarif)
...
```json
{
  ...
  "differential" : {
    ...
    },
    {
      ...
      "binding" : {
        "strength" : "extensible",
        "valueSet" : "https://hl7.fr/ig/fhir/core/ValueSet/fr-core-vs-oragnization-code-tarif-tnjp|2.2.0"
      }
    }]
  }
}
