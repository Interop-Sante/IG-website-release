# FR Core Observation Body Weight Profile - Guide d'implémentation FR Core v2.2.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **FR Core Observation Body Weight Profile**

## Resource Profile: FR Core Observation Body Weight Profile 

| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-observation-body-weight | *Version*:2.2.0 |
| Active as of 2026-03-25 | *Computable Name*:FRCoreObservationBodyWeightProfile |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.fr.core|current/StructureDefinition/fr-core-observation-body-weight)
...
Other representations of profile: [CSV](StructureDefinition-fr-core-observation-body-weight.csv), [Excel](StructureDefinition-fr-core-observation-body-weight.xlsx), [Schematron](StructureDefinition-fr-core-observation-body-weight.sch) 
...
```json
{
  ...
  "abstract" : false,
  "type" : "Observation",
  "baseDefinition" : "http://hl7.org/fhir/StructureDefinition/bodyweight|4.0.1",
  ...
  "differential" : {
    ...
    },
    {
      ...
      "min" : 0,
      "max" : "1",
      "patternCanonical" : "https://hl7.fr/ig/fhir/core/StructureDefinition/fr-core-observation-body-weight|2.2.0"
    },
    {
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/StructureDefinition/workflow-supportingInfo|5.2.0"]
      }]
    },
    {
