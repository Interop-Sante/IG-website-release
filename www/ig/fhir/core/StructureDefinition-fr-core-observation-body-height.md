...
| Active as of 2026-03-19 | *Computable Name*:FRCoreObservationBodyHeightProfile |
...
Vous pouvez également vérifier [les usages dans le FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.fr.core|current/StructureDefinition/fr-core-observation-body-height)
...
```json
{
  ...
  "abstract" : false,
  "type" : "Observation",
  "baseDefinition" : "http://hl7.org/fhir/StructureDefinition/bodyheight|4.0.1",
