# code system d'Interop'Santé - Codes du problème identifié dans l'intervention pharmaceutique - Guide d'implémentation de l'analyse pharmaceutique v0.1.0-ballot
