# Jeu de valeurs Interop'Santé - Codes de résultat d'analyse pharmaceutique - Guide d'implémentation de l'analyse pharmaceutique v0.1.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/analyse-pharma/ValueSet/fr-pharmaceutical-analysis-perfomer-type-value-set | *Version*:0.1.0-ballot |
| Draft as of 2026-05-29 | *Computable Name*:FrPharmaceuticalAnalysisPerformerTypeValueSet |
