# Conversion PN13 vers FHIR pour le résultat d'une analyse pharmaceutique de type intervention pharmaceutique sans proposition - Guide d'implémentation de l'analyse pharmaceutique v0.1.0-ballot
...
| | |
| :--- | :--- |
| *Official URL*:https://hl7.fr/ig/fhir/analyse-pharma/ConceptMap/PN13-FHIR-analpharm-interv-sans-prop-conceptmap | *Version*:0.1.0-ballot |
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/analyse-pharma/ConceptMap/PN13-FHIR-analpharm-interv-sans-prop-conceptmap",
  ...
  "targetUri" : "https://hl7.fr/ig/fhir/analyse-pharma/StructureDefinition/fr-inpatient-pharmaceutical-analysis-result",
  "group" : [{
    "element" : [{
