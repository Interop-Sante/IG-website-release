# Conversion PN13 vers FHIR pour le résultat d'une analyse pharmaceutiquede type validation - Guide d'implémentation de l'analyse pharmaceutique v0.1.0-ballot
...
```json
{
  ...
  "url" : "https://hl7.fr/ig/fhir/analyse-pharma/ConceptMap/PN13-FHIR-analpharm-val-conceptmap",
